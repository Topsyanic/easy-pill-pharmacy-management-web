<%-- 
    Document   : adminViewOrderPage
    Created on : Dec 15, 2021, 6:50:28 PM
    Author     : Topsy
--%>
            ...
            <section class="signup">           
                <div class="container">
                    <div class="signup-content">
                        <h2 class="form-title"> View Order</h2>
                        <p ><%=request.getParameter("orderDetails")%></p>
                        <br>
                        <br>
                        <div class="form-group">
                            <input type="submit" name="submit" id="submit" class="form-submit" value="Back" onclick="location.href = '${orderLink}'"/>
                        </div>                   
                    </div>
                </div>
            </section>
