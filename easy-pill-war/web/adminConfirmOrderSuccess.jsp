<%-- 
    Document   : adminConfirmOrderSuccess
    Created on : Dec 15, 2021, 7:06:47 PM
    Author     : Topsy
--%>
...
<html lang="en">
    <head>
        ...
        <title>Confirm Order Success</title>
        ...
        <section class="signup">           
            <div class="container">
                <div class="signup-content">
                    <h2 class="form-title"> Order successfully confirmed.</h2>
                    <p class="detail-box">The user has been sent an email notification.</p>
                    <br>
                    <br>
                    <div class="form-group">
                        <input type="submit" name="submit" id="submit" class="form-submit" value="Ok" onclick="location.href = '${orderLink}'"/>
                    </div>                   
                </div>
            </div>
        </section>
