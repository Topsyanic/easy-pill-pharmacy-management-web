<%-- 
    Document   : adminMedicineOutStockPage
    Created on : Dec 8, 2021, 2:18:47 PM
    Author     : Topsy
--%>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li><a href="${outStockLink}" class="active"><span class="las la-band-aid"></span><span>Medicine Out of Stock</span></a></li>
