<%-- 
    Document   : deleteSupplierSuccess
    Created on : Dec 1, 2021, 2:45:02 PM
    Author     : Topsy
--%>
...
<html lang="en">
    <head>
        ...
        <title>Delete Supplier Success</title>
            ...
            <section class="signup">           
                <div class="container">
                    <div class="signup-content">
                        <h2 class="form-title"> Supplier successfully removed.</h2>
                        <p class="detail-box">The supplier will no longer be visible in the system.</p>
                        <br>
                        <br>
