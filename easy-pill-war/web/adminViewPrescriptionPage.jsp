<%-- 
    Document   : adminViewPrescriptionPage
    Created on : Dec 9, 2021, 3:49:43 PM
    Author     : Topsy
--%>
            ...
            <section class="signup">           
                <div class="container">
                    <div class="signup-content">
                        <h2 class="form-title"> View Prescription</h2>
                        <img class="prescription-image" src='<%=request.getParameter("imagePath")%>'/>
                        <br>
                        <br>
                        <div class="form-group">
                            <input type="submit" name="submit" id="submit" class="form-submit" value="Back" onclick="location.href = '${prescriptionLink}'"/>
                        </div>                   
                    </div>
                </div>
            </section>
