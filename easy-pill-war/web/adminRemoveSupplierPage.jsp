<%-- 
    Document   : adminRemoveSupplierPage
    Created on : Dec 1, 2021, 2:40:28 PM
    Author     : Topsy
--%>
                ...
                <div class="container">
                    <div class="signup-content">
                        <form action="SupplierController" method="POST"  class="signup-form">
                            <input name='command' value='DELETESUPPLIER' hidden>
                            <input name='supplierId' value='<%=request.getParameter("supplierId")%>' hidden>
                            <h2 class="form-title">Remove Supplier</h2>
                            <p style='text-align: center; margin-bottom: 15px;'>Are you sure you want to remove the Supplier below?</p>
                            <div class="form-group">
                                <div class="form-group">
                                    <div class ='center'>
                                        <p class='verifyDesc'>Supplier Name: ${name}</p>
                                         <p class='verifyDesc'>Supplier Email: ${email}</p>
                                    </div>
                                </div>
