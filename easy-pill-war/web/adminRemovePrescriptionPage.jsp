<%-- 
    Document   : adminRemovePrescriptionPage
            ...
            <section class="signup">           
                <div class="container">
                    <div class="signup-content">
                        <form action="PrescriptionController" method="POST"  class="signup-form">
                            ...
                            <h2 class="form-title">Remove Prescription</h2>
                            <p style='text-align: center; margin-bottom: 15px;'>Are you sure you want to remove the Prescription below?</p>
                            <div class="form-group">
                                <div class="form-group">
                                    <div class ='center'>
                                        <p class='verifyDesc'>Prescription ID: <%=request.getParameter("prescriptionId")%></p>
                                    </div>
                                </div>
