<%-- 
    Document   : adminUpdateMedicineSuccessPage
    Created on : Nov 30, 2021, 3:32:06 PM
    Author     : Topsy
--%>
...
<html lang="en">
    <head>
        ...
        <title>Medicine Updated Successfully</title>
            ...
            <section class="signup">           
                <div class="container">
                    <div class="signup-content">
                        <h2 class="form-title"> Medicine Updated Successfully</h2>
                        <p style='text-align: center;'>The changes you made have been saved in the system.</p>
                        <br>
                        <br>
                        <div class="form-group">
                            <input type="submit" name="submit" id="submit" class="form-submit" value="OK" onclick="location.href = '${medicineLink}'"/>
                        </div>                   
                    </div>
                </div>
            </section>
